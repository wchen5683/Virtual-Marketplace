            ...
            if (choice.equals("1")) { // user chooses to login
                ...
                while (logged) {
                    if (accountData.get(3).equals("customer")) { // if the logged account is a customer
                        if (first) {
                            purchaseHistory = importPurchaseHistory(accountData.get(4));
                            first = !first;
                        }
                        Customer customer = new Customer(email, password, accountData.get(2), purchaseHistory);
                                ...
                                while (productMenu) {
                                    ...
                                    switch (choice) {
                                        ...
                                        case "4" -> {
                                            ...
                                            try {
                                                File importFile = new File(scan.nextLine());
                                        ...
                                        case "5" -> {
                                            ...
                                            String[] exports = scan.nextLine().split(", ");
                                            System.out.println("Enter the name of the exported file");
                                            String exportedName = scan.nextLine();
                                            try {
                ...
                if (created) {
                    ...
                    System.out.println("There was a problem with creating your account.");
                }
            } else { // EXIT option
                if (!(accountData == null)) {
